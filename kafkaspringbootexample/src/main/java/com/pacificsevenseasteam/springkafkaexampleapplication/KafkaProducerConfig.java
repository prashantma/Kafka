package com.pacificsevenseasteam.springkafkaexampleapplication;
...
class KafkaProducerConfig {
	...
	Map<String, Object> producerConfigs() {
		LOG.info("producerConfigs: BOOTSTRAP_SERVERS_CONFIG [{}]", bootstrapServers);
	...
	public RoutingKafkaTemplate routingTemplate(GenericApplicationContext context) {
		LOG.info("routingTemplate: BOOTSTRAP_SERVERS_CONFIG [{}]", bootstrapServers);
	...
	public ProducerFactory<String, User> userProducerFactory() {
		LOG.info("userProducerFactory: BOOTSTRAP_SERVERS_CONFIG [{}]", bootstrapServers);
	...
	@Bean
	public KafkaTemplate<String, User> userKafkaTemplate() { return new KafkaTemplate<>(userProducerFactory()); }
}